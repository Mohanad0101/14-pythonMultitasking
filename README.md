...
| **Порт** | `4444` (echo‑сервер) |
| **Объём** | Последовательный и многопоточный echo‑сервер; последовательный и многопоточный сканер портов (дополнить TODO, запустить и зафиксировать результаты) |
